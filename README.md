...
### Hardware Setup
1. Connect the NEMA 17 stepper motors and servos to the ESP32 via the **DRV885 driver** and the necessary power supplies.
...
### Testing
1. Ensure proper movement of the telescope by testing the stepper motors and servos.
